...
let Explainable = class Explainable extends decorators_1.ShellApiWithMongoClass {
    ...
    async count(query = {}, options = {}) {
        ...
        return helpers_1.markAsExplainOutput(await this._collection._database._runCommand({
            explain: {
    ...
    async remove(query, options = {}) {
        ...
        options = { ...helpers_1.processRemoveOptions(options), explain: this._verbosity };
    ...
    async mapReduce(map, reduce, optionsOrOutString) {
        ...
        const options = { ...helpers_1.processMapReduceOptions(optionsOrOutString), explain: this._verbosity };
        return this._collection.mapReduce(map, reduce, options);
    }
};
__decorate([
    decorators_1.returnType('ExplainableCursor'),
