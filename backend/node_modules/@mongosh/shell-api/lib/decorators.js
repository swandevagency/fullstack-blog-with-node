...
class ShellApiClass {
    ...
    set [enums_1.shellApiType](value) {
        helpers_1.addHiddenDataProperty(this, enums_1.shellApiType, value);
    }
    [enums_1.asPrintable]() {
...
function wrapWithAddSourceToResult(fn) {
    function addSource(result, obj) {
        if (typeof result === 'object' && result !== null) {
            ...
            helpers_1.addHiddenDataProperty(result, resultSource, resultSourceInformation);
            if (result[enums_1.shellApiType] === undefined && fn.returnType) {
                helpers_1.addHiddenDataProperty(result, enums_1.shellApiType, fn.returnType);
            }
        }
        return result;
    }
...
function checkForDeprecation(instanceState, className, fn) {
    if (instanceState && typeof instanceState.emitDeprecatedApiCall === 'function' && typeof fn === 'function' && fn.deprecated) {
...
function shellApiClassGeneric(constructor, hasHelp) {
    ...
    helpers_1.addHiddenDataProperty(constructor.prototype, enums_1.shellApiType, className);
    if (hasHelp) {
...
function markImplicitlyAwaited(orig) {
    function wrapper(...args) {
        ...
        return helpers_1.addHiddenDataProperty(origResult, Symbol.for('@@mongosh.syntheticPromise'), true);
    }
